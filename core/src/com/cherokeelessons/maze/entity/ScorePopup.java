...
//	}
	...
	private Runnable ding2=new Runnable() {
		@Override
		public void run() {
	...
	public ScorePopup(int count, float x, float y, BitmapFont font) {
		String scoreText="+"+count;
		...
		int c=0;
		while (count>0) {
			table.addAction((Actions.delay((float)c/4f, Actions.run(ding2))));
			c+=1;
			count/=5;
		}
	}
