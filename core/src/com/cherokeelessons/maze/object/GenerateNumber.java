...
public class GenerateNumber {
	...
	static private final String[] chr_xnumbers={"ᏃᏘ", "ᏍᎪᎯᏥᏆ", "ᏔᎵᏥᏆ", "ᏦᎢᏥᏆ", "ᏅᎩᏥᏆ", "ᎯᏍᎩᏥᏆ", "ᏑᏓᎵᏥᏆ", "ᎦᎵᏉᏥᏆ", "ᏁᎳᏥᏆ", "ᏐᏁᎳᏥᏆ"};
	static private final String[] chr_ynumbers={"ᏃᏘ", "ᏍᎪᎯ", "ᏔᎵᏍᎪᎯ", "ᏦᏍᎪᎯ", "ᏅᎩᏍᎪᎯ", "ᎯᏍᎩᏍᎪᎯ", "ᏑᏓᎵᏍᎪᎯ", "ᎦᎵᏆᏍᎪᎯ", "ᏁᎳᏍᎪᎯ", "ᏐᏁᎳᏍᎪᎯ"};
	static private final String[] chr_znumbers={"ᏃᏘ", "ᏌᏊ", "ᏔᎵ", "ᏦᎢ", "ᏅᎩ", "ᎯᏍᎩ", "ᏑᏓᎵ", "ᎦᎵᏉᎩ", "ᏣᏁᎳ", "ᏐᏁᎳ", "ᏍᎪᎯ", "ᏌᏚ", "ᏔᎵᏚ", "ᏦᎦᏚ", "ᏂᎦᏚ", "ᏍᎩᎦᏚ", "ᏓᎳᏚ", "ᎦᎵᏆᏚ", "ᏁᎳᏚ", "ᏐᏁᎳᏚ"};
	...
	static public String getRandomCardinal(int from, int to) {
	...
	static public Array<String> getAudioSequence(int number) {
		...
		for (int ix=9; ix>0; ix--){
			if (ix*100 > number) continue;
			number-=ix*100;
			list.add(ix*100+"");			
		}
		//20 -> 90
		for (int ix=9; ix>1; ix--){
			if (ix*10 > number) continue;
			number-=ix*10;
			if (number>0) {
				list.add(ix*10+"_");
			} else {
	...
	static private int roll(int count, int sides){
