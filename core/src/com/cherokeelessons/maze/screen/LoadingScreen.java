...
public class LoadingScreen extends ScreenBase {
	...
	private final PixmapPacker pack;
	private final TextureAtlas ta;

	public LoadingScreen(final NumbersMaze _app) {
		app = _app;
		showOverScan = false;
		...
		final float wscale = overscan.width / logo.getWidth();
		final float hscale = overscan.height / logo.getHeight();
		if (wscale > hscale) {
